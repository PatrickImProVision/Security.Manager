...
<div class="card prose">
    ...
    <div class="actions">
        ...
        <?php if (! empty($canManage)) : ?>
            <a class="btn btn-primary" href="<?= esc(\App\Libraries\CommunityContentUrls::editUrl($post)) ?>">Edit post</a>
            <a class="btn btn-danger" href="<?= esc(\App\Libraries\CommunityContentUrls::deleteUrl($post)) ?>">Delete post</a>
        <?php endif ?>
    </div>
</div>
<?= $this->endSection() ?>
