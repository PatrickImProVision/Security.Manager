...
ALTER TABLE __DB_PREFIX__users ADD COLUMN IF NOT EXISTS c_id VARCHAR(128) NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS __DB_PREFIX__users_c_id_unique ON __DB_PREFIX__users (c_id);
